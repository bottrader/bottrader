...
const port = process.env.PORT5 || 3000;
...
let strategyId = StrategyManager.getStrategies()[0].id;
let accountId = AccountManager.addAuth(exchangeId, 'gdax 5', {
	key: process.env.GDAX_KEY5,
  secret: process.env.GDAX_SECRET5,
  passphrase: process.env.GDAX_PASSPHRASE5
});
